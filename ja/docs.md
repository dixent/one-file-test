...
- 上記に挙げた言語グループに参加し、その言語の{a0 href="https://github.com/tensorflow/docs/tree/master/site"}<code>site/lang</code>{/a0}ディレクトリに関係する、*作成された*いかなるプルリクエストのメールも受け取るようにしましょう。★gitlocalizeで編集すると2重のtagが反映されない。
