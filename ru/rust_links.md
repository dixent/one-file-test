...
- **Зависимости от разработчиков** - когда пакет используется совместно как обычная зависимость и зависимость от разработчиков, функции зависимости от разработчиков включаются только в том случае, если текущая сборка включает зависимости от разработчиков.
